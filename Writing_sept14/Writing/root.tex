...
Sec.~\ref{sec::alg} provides a dynamic programming algorithm to compute under-approximations of risk-sensitive safe sets. %include proof?
...
\textcolor{blue}{Jonathan, can you please review/correct this footnote?}}
...
\footnotetext{see Lemma~\ref{lemma::infeqmin}}
\begin{equation*}\begin{aligned}
