...
%To compute the \textcolor{red}{sets, $\widehat{\mathcal{U}}_y^r$}, we solved for the value function, $J_0$, using the value-iteration algorithm~\eqref{bell} over our grid, and then extracted the $\beta e^{m \cdot r}$-sublevel sets, see~\eqref{under}.
