...
Kevin M. Smith$^{5}$,\\ Victoria Cheng$^{6}$, Jaime F. Fisac$^{1}$, Susmit Jha$^{2}$, Marco Pavone\textsuperscript{7}, Claire J. Tomlin$^{1}$% <-this % stops a space
...
%General references on CVaR include~\cite{serraino2013conditional} and~\cite{kisiala2015conditional}.
